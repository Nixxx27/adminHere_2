...
<div class="row">
    ...
    <div class="col-md-12" style="margin-bottom: 10px" ><button class="btn btn-danger" title="Add Tracking number Series"  data-toggle="modal" data-target="#responsive-modal"><i class="fas fa-plus-square fa-2x"></i></button>
                            ...
                            <tr>
                                <td>
                                 {!! Form::open(['method'=>'GET', 'action' => ['TrolleysController@edit', $trolley->id]]) !!}
                                    <button class="btn waves-effect btn-sm waves-light btn-info" title="Click to Edit Trolley # {{ ucwords($trolley->tracking_number)}}?">
                                ...
                                {!! Form::open(['method'=>'DELETE', 'action' => ['TrolleysController@destroy', $trolley->id]]) !!}
                                   <button class="btn waves-effect btn-sm  waves-light btn-danger" onclick="return confirm('Are you sure you want to delete Trolley # {{ucwords($trolley->tracking_number)}} ?')" title="Click to Delete Trolley # {{ucwords($trolley->tracking_number)}}?">
